...
namespace EsteCarII.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Designacao")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Designacao")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
